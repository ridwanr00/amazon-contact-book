...
class ContactBookTest {
    ...
    public void testAddContact() {
        ...
        int currentNumOfContacts = testContactBook.getNumberOfContacts();
        testContactBook.addContact(testContact);
         ...
         **/
        Assertions.assertEquals(testContactBook.getNumberOfContacts(), currentNumOfContacts +1);
    ...
    public void testSearchContactByPhone() {
        ...
        ContactBook testContactBook = new ContactBook();
        testContactBook.addContact(testContactForPhone);

        Contact searchedContact = testContactBook.searchContactByPhone("184048");

        Assertions.assertNotNull(searchedContact.getName(), searchedContact.getPhoneNumber());
    ...
    public void testRemoveContactByPhone_found_returnsTrue() {
         ...
         **/
        Assertions.assertTrue(contactBook.deleteContactByPhone(testContactForPhone.getPhoneNumber()));
    }
